...
**Go to: `https://grafana.tail6d0ed4.ts.net` → Homelab → "Fleet Workforce — Triage".**
...
3. For 3–5 of them: open GlitchTip (`https://glitchtip.tail6d0ed4.ts.net`) and sanity-check
